...
#define _CPLX 0 // Carpalx QGMLWY
#define _QWTY 1 // QWERTY
#define _FNPD 9 // Function, Numpad

#define DF_CPLX DF(_CPLX)
#define DF_QWTY DF(_QWTY)
#define TT_FNPD TT(_FNPD)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWTY] = LAYOUT_dactylx(
        KC_EQL , KC_1  , KC_2   , KC_3   , KC_4   , KC_5   , KC_COPY,       DF_CPLX, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS,
    ...
    [_CPLX] = LAYOUT_dactylx(
        KC_EQL , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_COPY,      DF_QWTY, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS,
        KC_TAB , KC_Q   , KC_G   , KC_M   , KC_L   , KC_W   , KC_PSTE,      KC_CAPS, KC_Y   , KC_F   , KC_U   , KC_B   , KC_SCLN, KC_BSLS,
        KC_LCTL, KC_D   , KC_S   , KC_T   , KC_N   , KC_R   , TT_FNPD,      TT_FNPD, KC_I   , KC_A   , KC_E   , KC_O   , KC_H   , KC_QUOT,
        KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_J   ,                        KC_K   , KC_P   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
        KC_ESC , KC_GRV , KC_PAUS, KC_LEFT, KC_RGHT, KC_BSPC, KC_DEL ,      KC_ENT , KC_SPC , KC_UP  , KC_DOWN, KC_LBRC, KC_RBRC, KC_RGUI,
                                   KC_END , KC_HOME, KC_LALT, KC_LGUI,      KC_RCTL, KC_RALT, KC_PGUP, KC_PGDN
    ),

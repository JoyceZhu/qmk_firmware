...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_dactylx(
        ...
        KC_TAB , KC_Q  , KC_W   , KC_E   , KC_R   , KC_T   , LT(_FNPD, KC_MPRV),      LT(_FNPD, KC_MPRV), KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_BSLS,
        ...
        KC_LEFT, KC_RGHT, KC_UP, KC_DOWN, KC_RGUI,
             KC_END , KC_HOME, KC_BSPC, KC_LGUI,
    ...
    [_WINDOWS] = LAYOUT_dactylx(
        ...
        KC_LEFT, KC_RGHT, KC_UP, KC_DOWN, KC_RCTL,
             KC_END , KC_HOME, KC_BSPC, KC_LCTL,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAV] = LAYOUT(KC_ESC, KC_PSLS, KC_PAST, KC_PMNS, KC_DLR, KC_PERC, KC_INS, KC_HOME, KC_PGUP, KC_MINS, KC_EQL, KC_PGUP, RESET, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_5, KC_DEL, KC_END, KC_PGDN, KC_LBRC, KC_RBRC, KC_PGDN, KC_CAPS, KC_P4, KC_P5, KC_P6, KC_PPLS, KC_LBRC, KC_VOLD, KC_UP, KC_VOLU, KC_MUTE, KC_MPLY, KC_HOME, KC_LSFT, KC_P1, KC_P2, KC_P3, KC_0, TO(2), LCTL_T(KC_DEL), KC_MUTE, KC_LEFT, KC_DOWN, KC_RGHT, KC_MPRV, KC_MNXT, KC_END, TO(0), KC_LGUI, KC_BSPC, KC_SPC, RCTL_T(KC_ENT), RALT_T(KC_EQL)),
